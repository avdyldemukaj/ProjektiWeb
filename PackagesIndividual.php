...
<header class="header">
      <h3 class="logo">IndividualPackages<span></span></h3>
      <nav class="navbar">
...
<div class="row">
        ...
        <br>
        <br>
    <h1 class="main-text">PackageIndividual Application</h1><br><br><br>
        <main id="mainStyle">
    <div class="left-side">
        <?php
            include 'confingPackagesIndividual.php';
            $book = new DatabasePackagesIndividualy();
            $check = $book->check();
        ?> 
