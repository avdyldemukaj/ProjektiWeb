...
<title>PackagesIndividual</title>
...
<header class="header">
        <h3 class="logo">PackagesIndividual<span></span></h3>
        <nav class="navbar">
          <li class="navlist">
...
<br><br>
    ...
    <h1 class="main-text">PackagesIndividual</h1><br><br><br>
        <main id="mainStyle">
    <div class="left-side">
        <!-- <?php
            include 'configPackagesIndividual.php';
            $donateMoneyRegister = new DatabasePackagesIndividual();
            $check = $donateMoneyRegister->check();
        ?>  -->
        <form name="myForm" onsubmit="return validatePackagesIndividual()" method="post">
            <div>
    ...
    <script src="PackagesIndividual.js"></script>
</body>
