...
<header class="header">
        <h3 class="logo">PackagesDuo<span></span></h3>
        <nav class="navbar">
          <li class="navlist">
...
<br><br>
    ...
    <h1 class="main-text">PackagePackagesDuosIndividual</h1><br><br><br>
        <main id="mainStyle">
    <div class="left-side">
        <!-- <?php
            include 'configPackagesDuo.php';
            $donateMoneyRegister = new DatabasePackagesDuo();
    ...
    <script src="PackagesDuo.js"></script>
</body>
